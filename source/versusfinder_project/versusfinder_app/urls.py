...
urlpatterns = [
    ...
    # Timetables
    path('dashboard/gameprofiles/<gameprofile_id>/timetables', views.timetable, name='timetable'),
    path('dashboard/gameprofiles/<gameprofile_id>/timetables/new', views.timetable_new, name='timetable.new'),
    path('dashboard/gameprofiles/<gameprofile_id>/timetables/<timetable_id>/delete', views.timetable_delete, name='timetable.delete'),
