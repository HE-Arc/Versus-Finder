# Generated by Django 2.1.7 on 2019-03-13 09:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('character', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='versusfinder_app.Character')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banlist', models.ManyToManyField(to='versusfinder_app.UserCharacterBanList')),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='versusfinder_app.Game')),
